...
This project is indexed by GitNexus as **planarclip** (1517 symbols, 2553 relationships, 127 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
