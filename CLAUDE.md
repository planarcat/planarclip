...
This project is indexed by GitNexus as **planarclip** (666 symbols, 925 relationships, 27 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
