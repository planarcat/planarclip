...
This project is indexed by GitNexus as **planarclip** (258 symbols, 321 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
