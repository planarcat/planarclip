...
This project is indexed by GitNexus as **planarclip** (1418 symbols, 2443 relationships, 86 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
