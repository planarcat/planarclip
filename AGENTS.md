...
This project is indexed by GitNexus as **planarclip** (2369 symbols, 4381 relationships, 201 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
