...
This project is indexed by GitNexus as **planarclip** (1885 symbols, 3309 relationships, 159 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
