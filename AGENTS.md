...
This project is indexed by GitNexus as **planarclip** (1684 symbols, 3221 relationships, 141 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
